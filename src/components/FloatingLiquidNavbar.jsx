    ...
    <nav className="absolute bottom-5 left-1/2 -translate-x-1/2 z-40 px-3 py-2 rounded-full liquid-glass shadow-2xl flex items-center gap-1.5 border border-white/20 animate-spring-up pointer-events-auto">
      ...
      {leftItems.map((item) => {
        ...
        return (
          <button
            ...
            className={`relative flex items-center justify-center w-11 h-11 rounded-full transition-all duration-300 active:scale-90 ${
              isActive
      ...
      <div className="px-0.5">
        <button
          ...
          className="w-12 h-12 rounded-full bg-gradient-to-tr from-emerald-500 to-teal-400 text-white shadow-lg shadow-emerald-500/40 flex items-center justify-center hover:scale-105 active:scale-90 transition-all duration-300"
          title="Add Log"
        >
